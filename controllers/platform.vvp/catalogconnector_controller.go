...
func (r *CatalogConnectorReconciler) attachFinalizers(sp platformvvpv1alpha1.CatalogConnector) error {
	ctx := context.Background()
...
func (r *CatalogConnectorReconciler) detachFinalizers(sp platformvvpv1alpha1.CatalogConnector) error {
	ctx := context.Background()
	log := log.FromContext(ctx)
	if controllerutil.ContainsFinalizer(&sp, platformFinalizer) {
